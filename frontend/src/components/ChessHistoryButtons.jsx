  ...
  return (
    <div className="flex justify-around gap-2 lg:gap-4 mt-4 max-w-screen">
      <button
        ...
        className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-1 lg:py-2 px-2 lg:px-4 rounded-lg shadow-lg transition-transform transform cursor-pointer"
      >
        ⏮
      </button>
      <button
